...
module SucNat.Properties {X : Set} {X-dec : Decidable {A = X} _≡_ } where
...
-- END UGLY
  ...
  module QHSN = QH-Atomic Atoms.atomAtomic
  open QHSN public
